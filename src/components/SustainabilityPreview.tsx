        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-7">
            <ScrollReveal>
              ...
              <h2 className="text-5xl md:text-7xl lg:text-[6.5rem] font-serif tracking-tight leading-[0.9] text-white mb-8">
                Packaging<br/>
                <span className="text-white/30 italic">That Cares.</span>
              </h2>
              ...
              <div className="grid sm:grid-cols-3 gap-4 mb-10">
                <div className="text-center p-6 bg-black border border-white/5 rounded-none">
                  <Leaf className="w-5 h-5 text-emerald mx-auto mb-3" />
                  <p className="font-sans text-xs font-medium text-white/90">Compostable</p>
                </div>
                <div className="text-center p-6 bg-black border border-white/5 rounded-none">
                  <Recycle className="w-5 h-5 text-emerald mx-auto mb-3" />
                  <p className="font-sans text-xs font-medium text-white/90">Recyclable</p>
                </div>
                <div className="text-center p-6 bg-black border border-white/5 rounded-none">
                  <TreePine className="w-5 h-5 text-emerald mx-auto mb-3" />
                  <p className="font-sans text-xs font-medium text-white/90">Carbon Negative</p>
                </div>
              </div>
          ...
          <div className="lg:col-span-5">
            <ScrollReveal delay={200} direction="right">
              <div className="relative group aspect-square rounded-none overflow-hidden border border-white/10 shadow-2xl">
                <img 
                  src="/products/packaging-1.jpg" 
                  alt="Sustainable Packaging" 
                  className="w-full h-full object-cover opacity-70 transform transition-transform duration-700 group-hover:scale-[1.02]"
                />
                {/* Floating Eco Badge */}
                <div className="absolute bottom-6 left-6 bg-black/90 backdrop-blur-md px-4 py-2 rounded-none border border-white/10 flex items-center gap-2">
                  <Leaf className="w-3.5 h-3.5 text-emerald" />
                  <span className="text-xs font-mono text-white/90">100% Eco-Friendly</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
