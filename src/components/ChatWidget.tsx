    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex items-center gap-2.5 bg-[#1d0a27] border border-white/15 hover:border-accent/40 text-white px-4 py-3 rounded-full shadow-2xl transition-all duration-300 transform hover:-translate-y-0.5 group"
          aria-label="Open chat"
        >
          <div className="relative flex items-center justify-center">
            <div className="absolute inset-0 bg-accent rounded-full animate-ping opacity-20"></div>
            <div className="relative flex items-center justify-center w-7 h-7 rounded-full bg-white/10 border border-white/20 overflow-hidden">
              <img src="/assets/assistant-logo.png" alt="InTheBox" className="w-full h-full object-cover" />
            </div>
          </div>
          <span className="font-mono text-xs uppercase tracking-wider font-medium text-white/90 group-hover:text-accent transition-colors">
            Chat
          </span>
        </button>
      )}
      ...
      <div
        className={`fixed z-50 transition-all duration-300 ease-out
          ...
          w-[calc(100vw-32px)] max-w-[350px] sm:w-[350px]
          h-[460px] max-h-[80vh]
          ...
          <div className="flex items-center justify-between gap-2 px-4 py-3 border-b border-white/10 bg-[#15071d] flex-shrink-0">
            <div className="flex items-center gap-2.5 min-w-0">
              <div className="w-8 h-8 rounded-full bg-white/10 border border-white/20 flex items-center justify-center flex-shrink-0 overflow-hidden">
                <img src="/assets/assistant-logo.png" alt="Assistant" className="w-full h-full object-cover rounded-full" />
              </div>
            ...
            <div className="flex items-center gap-2 flex-shrink-0">
              ...
              <a
                ...
                className="flex items-center gap-1.5 bg-[#25D366]/15 hover:bg-[#25D366]/25 text-[#25D366] border border-[#25D366]/30 px-2.5 py-1.5 rounded-full transition-colors"
